<?php 
    ...
    //查询新闻信息
    $newslist = $db->getDatas('news', 'news_id, title, updatetimes', 'cate_id_parent=2 AND cate_id_child=5');
    // var_dump($newslist);
                ...
                <div class="new-list">
                    ...
                    <?php 
                        foreach ($newslist as $key => $value) {
                            echo '<li><a href="./new_info.php?news_id='.$value['news_id'].'"><span>'.$value['title'].'</span><em>'.$value['updatetimes'].'</em></a></li>';
                        }
                    ?>
                    </ul>
                </div>
